...
|:---:|:---|:---|
| 🔐 | **Login Pages** | Stylish, responsive login & signup UI with modern CSS |
| 🐍 | **Python Problems** | Scripts, challenges & problem-solving — beginner to intermediate |
| ☕ | **Java Programs** | Core Java, OOP, logic building & DSA |
| 🌐 | **Frontend Websites** | Clean, responsive web pages with HTML, CSS & JavaScript |
